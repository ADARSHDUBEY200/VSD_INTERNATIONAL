...
/* ───────────────────────────────────────────────────────────────────────────
   LoaderIntro — brand entrance for the Home Page. On first paint a dark
   curtain covers the page while the VSD logo does a 3D "coin-flip" spin
   inside a pulsing gold halo; the curtain then lifts away to reveal the page.
   Scroll is locked during the intro. Reduced-motion users get a quick fade.
   ─────────────────────────────────────────────────────────────────────────── */
