...
/* ───────────────────────────────────────────────────────────────────────────
   LeadPopupIce — ice-machine variant of the paid-ads lead popup.
   ...
   ice-machine copy and the `lp_commercial_ice_cube_machine` enquiry source.
   ─────────────────────────────────────────────────────────────────────────── */
...
const SESSION_KEY = 'vsd_lp_ice_popup_seen';
...
export default function LeadPopupIce() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Get your free commercial ice cube machine quote"
      onClick={close}
    >
      <div className="lp-popup-card" onClick={(e) => e.stopPropagation()}>
        ...
        <LeadForm
          ...
          subheading="Free capacity assessment + itemised quote. Takes 30 seconds."
          ctaLabel="Send the Free Quote"
          source="lp_commercial_ice_cube_machine"
        />
      </div>
    </div>
  );
